         ...
         <div class="row" style="height:640px;">
            @foreach($newYearWordPosts as $newYearWordPost)
                <div class="" style=" margin-right: 15px;">
                    <table class="">
                        <tr>
                            <p class="text-nowrap" style="line-height: 1.0;  font-weight:1000; padding-top: 10px; padding-left: 10px; padding-right: 30px;">{{$newYearWordPost->name}}</p>
                        </tr>
                        <tr>
                            @isset ($newYearWordPost->photo)
                            <td style="padding-top: 20px;">
                                <a href="{{ Storage::disk('s3')->url("{$newYearWordPost->photo}") }}" data-lightbox="group">
                                    <img src="{{ Storage::disk('s3')->url("{$newYearWordPost->photo}") }}" class="" width="250" height="180"/>
                                </a>
                            </td>
                            @endisset
                            
                            <td class="" style="height: 450px; line-height: 1.0; font-weight:800; padding: 20px 10px 10px 10px;">{{$newYearWordPost->explain}}</td>
                        </tr>
                        <tr>
